...
namespace UPExciseLTS
{
    public class RandomImage
    {
        ...
        private void GenerateImage()
        {
            ...
            path.AddString(this.text, font.FontFamily, (int)font.Style, 100, rect, format);
            float v = 4F;
            PointF[] points =
          {
            ...
            hatchBrush = new HatchBrush(HatchStyle.Percent10, Color.White, Color.Black);
